...
public abstract class ImageWorker {
    ...
    private void setImageBitmap(ImageView imageView, Bitmap bitmap) {
        ...
        if (mFadeInBitmap) {
            ...
            final ScaleAnimation scaleAnim = new ScaleAnimation(0.8f, 1.0f, 0.8f, 1.0f, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF,0.5f);
            scaleAnim.setDuration(FADE_IN_TIME/2);
            scaleAnim.setInterpolator(new AnticipateInterpolator());
